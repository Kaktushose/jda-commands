...
public interface ErrorMessageFactory {
     ...
     */
    MessageCreateData getInsufficientPermissionsMessage(@NotNull InvocationContext<?> context);
     ...
     */
    MessageCreateData getConstraintFailedMessage(@NotNull InvocationContext<?> context, @NotNull ConstraintDefinition constraint);
     ...
     */
    MessageCreateData getCooldownMessage(@NotNull InvocationContext<?> context, long ms);
     ...
     */
    MessageCreateData getWrongChannelTypeMessage(@NotNull InvocationContext<?> context);
     ...
     */
    MessageCreateData getCommandExecutionFailedMessage(@NotNull InvocationContext<?> context, @NotNull Throwable exception);
     ...
     */
    MessageCreateData getUnknownInteractionMessage(@NotNull InvocationContext<?> context);
