...
[![Generic badge](https://img.shields.io/badge/Download-4.0.0--alpha.2-green.svg)](https://github.com/Kaktushose/jda-commands/releases/latest)
...
|-----------------------------------------------------------------------------|-|--|---|---|
| [4.0.0-alpha.2](https://github.com/Kaktushose/jda-commands/releases/latest) |5|❌|✅|❌|
