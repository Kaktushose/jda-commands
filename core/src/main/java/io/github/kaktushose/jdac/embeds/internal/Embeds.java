package io.github.kaktushose.jdac.embeds.internal;
...
public record Embeds(Collection<EmbedDataSource> sources,
    ...
    public static class Configuration implements EmbedConfig {
        ...
        public Configuration(MessageResolver messageResolver, Collection<EmbedDataSource> dataSources) {
            this.messageResolver = messageResolver;
            sources = new ArrayList<>(dataSources);
