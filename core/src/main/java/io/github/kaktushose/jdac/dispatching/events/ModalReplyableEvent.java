...
import static io.github.kaktushose.jdac.introspection.internal.IntroAccess.accInvocationContext;
import static io.github.kaktushose.jdac.introspection.internal.IntroAccess.accInteractionRegistry;
...
public abstract sealed class ModalReplyableEvent<T extends GenericInteractionCreateEvent>
    ...
    public void replyModal(String modal, Function<ModalBuilder, ModalBuilder> callback) {
        InteractionDefinition definition = accInvocationContext().definition();
        ...
        if (jdaEvent() instanceof IModalCallback modalCallback) {
            ...
            var modalDefinition = accInteractionRegistry().find(ModalDefinition.class, false, it ->
