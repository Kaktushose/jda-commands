...
/// This interface provides read-only access to the indexed [Definition]s which are used to build and execute
/// interactions.
///
/// This may be useful if you want to build a help command for example or get access to individual metadata
/// annotation on
