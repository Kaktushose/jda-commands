...
public sealed interface NonCustomIdJDAEntity<T> extends JDAEntity<T>
        permits TextInputDefinition, CommandDefinition, OptionDataDefinition, MenuOptionDefinition {
