...
public interface Invoker {
    ...
    ///
    /// @param instance  an instance of the declaring class of the method or null for static methods
    ...
    @Nullable Object invoke(@Nullable Object instance, SequencedCollection<Object> arguments) throws IllegalAccessException, InvocationTargetException;
}
