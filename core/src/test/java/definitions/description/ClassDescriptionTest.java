...
class ClassDescriptionTest {
    ...
    void testAnnotation() {
        ...
        Interaction interaction = classDescription.findAnnotation(Interaction.class).orElseThrow();
    ...
    void testPackageDescription() {
        ...
        assertEquals(Bundle.class, description.findAnnotation(Bundle.class).orElseThrow().annotationType());
    ...
    void testParameterDescription() {
        ...
        assertEquals(Param.class, third.findAnnotation(Param.class).orElseThrow().annotationType());
